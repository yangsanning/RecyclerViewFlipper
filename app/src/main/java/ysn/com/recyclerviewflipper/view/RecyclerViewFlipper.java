package ysn.com.recyclerviewflipper.view;
 ...
 */
public class RecyclerViewFlipper extends RecyclerView {
    ...
    public RecyclerViewFlipper(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init() {
        handler = new Handler(msg -> {
            if (msg.what == 1) {
                //竖直滚动或者水平滚动，偏移值
                RecyclerViewFlipper.this.scrollBy(1, 1);
            }
            return false;
        });
