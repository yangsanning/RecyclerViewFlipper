package ysn.com.recyclerviewflipper.LayoutManager;
 ...
 * @Description RecyclerView无限循环滚动最优解
 * @Date 2019/7/2
 * @History 2019/7/2 author: description:
 */
        ...
        for (int i = 0; i < getChildCount(); i++) {
            ...
            if (dx > 0) {
                ...
                if (view.getRight() < 0) {
                    ...
                    Log.d("test", "循环: 移除 一个view  childCount=" + getChildCount());
                }
            } else {
